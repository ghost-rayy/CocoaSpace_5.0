...
Route::get('/staff/dashboard', [UserController::class, 'sdash'])->middleware('auth')->name('dashboard');
Route::get('/staff/create/booking', [UserController::class, 'createBooking'])->middleware('auth')->name('booking.create');
...
Route::get('/admin/dashboard', [AdminController::class, 'adash'])->middleware('auth')->name('admin.dashboard');
